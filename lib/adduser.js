...
function readEmail (c, u, cb) {
  ...
  var r = { prompt: "Public Email: ", default: c.e || "" }
...
function save (c, u, cb) {
  ...
  registry.adduser(u.u, u.p, u.e, function (er) {
    ...
    registry.password = u.p
    registry.email = u.e
    npm.config.set("username", u.u, "user-reg")
    npm.config.set("_password", u.p, "user-reg")
    npm.config.set("email", u.e, "user-reg")
    npm.config.del("_token", "user")
    npm.config.del("_token", "user-reg")
