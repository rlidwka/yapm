...
Conf.prototype.add = function (data, marker) {
  ...
  !function add_registry_overrides() {
    var registryKey = this.get('registry')
    var olddata = data
    var marker2
    if (Object.prototype.hasOwnProperty.call(olddata, 'registries')
    &&  Object.prototype.hasOwnProperty.call(olddata.registries, registryKey)) {
      data = olddata.registries[registryKey]
      unmask_password(data)
    } else {
